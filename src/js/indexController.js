    ...
    get(child(dbRef, "Songs/"+name)).then((snapshot)=>{
        if(snapshot.exists()){
            ...
            let currentLI =  `<li class="songItem">
                ...
                <div class="songHPlayIcon"><i class="fa-solid fa-play"></i></div>
            </li>`;
...
let yourHeaderPlaylists = document.querySelector('.usersPlaylistsSide');

function LoadUserPlaylists(){
    yourPlaylists.innerHTML = "";
    yourHeaderPlaylists.innerHTML = `<button onclick="openLikedSongs()"><img src="images/favorites.jpg" alt="Favorites"><p>Favorites</p></button>`;
